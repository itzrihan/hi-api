...
/**
 * Creates standardized API routes with error handling.
 * @param {Express.App} app - Express application instance.
 * @param {Function} jsonResponse - Success response handler.
 * @param {Function} jsonError - Error response handler.
 */
export const createApiRoutes = (app, jsonResponse, jsonError) => {
  /**
   * Helper function to create a GET route with error handling.
   * @param {string} path - API endpoint path.
   * @param {Function} controllerMethod - Controller function to handle the request.
   */
  ...
  // Home route (handles both `/api` and `/api/`)
  ...
  // Dynamic category routes (e.g., `/api/genre/action`)
